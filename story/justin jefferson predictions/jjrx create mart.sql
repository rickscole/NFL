...
GO
alter procedure [jjprx].[nfl_create_mart] as 
...
drop table jjprx.nfl_actual_and_trend; 
...
into jjprx.nfl_actual_and_trend
from (select distinct pfr_player_id, pfr_game_id, player_game_id, receiving_rat, instant, short, medium, intermediate, long from temp.nfl_jj_rating_prediction_02) t_00 
